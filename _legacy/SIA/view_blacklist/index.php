    ...
    <div class="main-panel">
      <div class="content-wrapper">
        ...
        <div class="d-xl-flex justify-content-between align-items-start">
          <h2 class="text-dark font-weight-bold mb-2"> Blacklisted Students </h2>
            ...
            <div class="d-sm-flex justify-content-between align-items-center transaparent-tab-border {">
              <div class="row">
                ...
                $sql = "SELECT student_registration.first_name, student_registration.last_name, student_registration.index_number,
                              blacklist_students.index_number, blacklist_students.reason, blacklist_students.date_added
                              FROM blacklist_students
                              INNER JOIN student_registration ON blacklist_students.index_number=student_registration.index_number";
                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Date of Blacklist</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
