...
$sql = "SELECT COUNT(table_id) FROM rmu_active_students";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$rmu_active_students = $row[0];


$sql = "SELECT COUNT(table_id) FROM student_applications WHERE room_Status='PENDING' ";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
$pending_applications = $row[0];


$sql = "SELECT COUNT(table_id) FROM blacklist_students ";
$result = mysqli_query($conn, $sql);
$row = mysqli_fetch_array($result);
              ...
              <div class="tab-pane fade show active" id="business-1" role="tabpanel" aria-labelledby="business-tab">
                <div class="row">
                  <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body text-center">
                        <h3 class="mb-2 text-dark font-weight-normal">Number of Students Uploaded</h5><br /><br /><br />
                          <h2 class="mb-4 text-dark font-weight-bold"><?php echo ($rmu_active_students) ?></h2>
                  ...
                  <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body text-center">
                        <h3 class="mb-2 text-dark font-weight-normal">Number of Pending Accomm. Requests</h5><br /><br /><br />
                          <h2 class="mb-4 text-dark font-weight-bold"><?php echo ($pending_applications) ?></h2>
                          <a href="../view_pending_applications">
                            <div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-office-building icon-md absolute-center text-dark"></i></div>
                          </a>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body text-center">
                        <h3 class="mb-2 text-dark font-weight-normal">Number of Blacklisted Students</h5><br /><br /><br />
                  ...
                  <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body text-center">
                        <h3 class="mb-2 text-dark font-weight-normal">Number of Active Rooms</h5><br /><br /><br />
                          <h2 class="mb-4 text-dark font-weight-bold"><?php echo ($blacklisted_students) ?></h2>
                          <a href="../add_rooms">
                            <div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-office-building icon-md absolute-center text-dark"></i></div>
                          </a>
                  ...
                  <div class="col-xl-4  col-lg-6 col-sm-6 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body text-center">
                        <h3 class="mb-2 text-dark font-weight-normal">Number of Processed Accommodation Requests</h5><br /><br /><br />
                          <h2 class="mb-4 text-dark font-weight-bold"><?php //echo($rmu_active_students) 
                                                                      ?></h2>
                          <a href="../view_courses">
                            <div class="dashboard-progress dashboard-progress-3 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-book-open-outline icon-md absolute-center text-dark"></i></div>
                          </a>
                      </div>
                    </div>
                  </div>
