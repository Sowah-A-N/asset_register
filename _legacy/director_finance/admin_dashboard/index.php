...
/*
$sql="SELECT COUNT(table_id) FROM lecture_hall_data";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($result);
$lecture_hall_count=$row[0];

$sql="SELECT COUNT(table_id) FROM course_data";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_array($result);
$course_count=$row[0];*/
                      ...
                      <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            ...
                            <a href="../view_lecturers"><div class="dashboard-progress dashboard-progress-1 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-account icon-md absolute-center text-dark"></i></div></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-4 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h3 class="mb-2 text-dark font-weight-normal">Number of Lecture Halls</h5><br /><br /><br />
                            <h2 class="mb-4 text-dark font-weight-bold"><?php// echo($registry_graduating_class) ?></h2>
                            <a href="../view_lecture_halls"><div class="dashboard-progress dashboard-progress-2 d-flex align-items-center justify-content-center item-parent"><i class="mdi mdi-office-building icon-md absolute-center text-dark"></i></div></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-xl-4  col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body text-center">
                            <h3 class="mb-2 text-dark font-weight-normal">Number of Courses</h5><br /><br /><br />
                            <h2 class="mb-4 text-dark font-weight-bold"><?php //echo($registry_graduating_class) ?></h2>
