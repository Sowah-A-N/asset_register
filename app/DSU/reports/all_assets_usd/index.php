    ...
    if($result->num_rows > 0){
        ...
        while($row = $result->fetch_assoc()){            
            echo "<tr id =". $row['asset_id'] . "><td class='border px-4 py-2'>". $row['asset_name']."</td>
                    ...
                    <td class='border px-4 py-2'>" . "<button class='bg-blue-500 text-white px-4 py-2 rounded' onclick=\"window.location.href='../individual_assets_usd/index.php?asset_id={$row['asset_id']}'\">"."View Records"."</button>" . "</td></tr>";
