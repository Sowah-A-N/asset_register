...
{
    $class_rate= $assetClassInfo['asset_class_info']['rate'];
    ...
    echo "<td>" . number_format(($assetClassInfo['asset_class_info']['net_book_value_usd']), 2) . "</td>";
    echo "</tr>";
    ...
    echo "<td>" . number_format(($assetClassInfo['total_disposals']/$class_rate), 2) . "</td>";
...
function displayData($yearOfReport, array $assetData, array $assetClassData)
{
    ...
    if (!$assetData["assetsData"]) {
        ...
        echo "</tr>";
        $class_rate= $assetClassData['asset_class_info']['rate'];
        ...
        $g_total_BookValueEnd = ($assetClassData['asset_class_info']['net_book_value_usd']) +($assetData["assetsTotals"]["totalBookValueEnd"]);
