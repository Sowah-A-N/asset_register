...
<?php
// Build a root-relative URL to notify.js using DOCUMENT_ROOT — works on any
// machine and any folder name. dirname(__DIR__) = app root (where assets/ lives).
$_notifyBase = rtrim(str_replace(
    rtrim($_SERVER['DOCUMENT_ROOT'], '/'),
    '',
    rtrim(dirname(__DIR__), '/')
), '/');
?>
<script src="<?= esc($_notifyBase) ?>/assets/js/notify.js"></script>
