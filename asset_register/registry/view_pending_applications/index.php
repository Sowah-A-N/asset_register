...
<!--Table goes here -->
                        <?php
                        $sql="SELECT student_registration.first_name, student_registration.last_name, student_registration.index_number,
                              student_applications.index_number, student_applications.hostel_name, student_applications.room_type, student_applications.sex
                              FROM student_applications
                              INNER JOIN student_registration ON student_applications.index_number=student_registration.index_number
                      ...
                      $serial_number=1;
                                    while($row= mysqli_fetch_array($result))
                                   {
                                        ...
                                        <?php echo "<input type=hidden name=id value='".$row['index_number']."' ?>"; ?>   
                                        <td><button type="submit" class="btn btn-success" name="approve">Approve</button></td>
                                        <td><button type="submit" class="btn btn-danger" name="decline">Decline</button></td>
                                        </form>
                                        <?php
                                        echo "</form></tr>"; 
                                        $serial_number++;
