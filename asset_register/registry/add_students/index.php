...
if(isset($_POST['add']))
{
   ...
   if(empty($index_no)||empty($programme))
   {
   ...
   { 
    ...
    $query="SELECT * FROM rmu_active_students WHERE index_number='$index_no'";
    ...
    else
    {
      ...
      $query="INSERT INTO rmu_active_students (index_number, programme_studied) 
      VALUES ('$index_no', '$programme')";
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <select class="custom-select" id="inputGroupSelect02" name="programme">
                                    <option selected>Programme of Student</option>
                                    <?php
