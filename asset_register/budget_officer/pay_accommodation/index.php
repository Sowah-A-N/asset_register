...
{
  echo "<script> alert('You have not been cleared to access the Payment Gateway'); window.location='../dashboard/' </script> ";
  exit();
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> Apply For Accommodation </h2>
                      ...
                      <div class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                          ...
                          <div class="card" style="width: 20rem;">
                            <div class="card-body">
                              <h5 class="card-title">Room Choice</h5>
                              <p class="card-text">	<h6>Hostel Name: Back Accommodation</h6>
                            <form method="POST" action="index.php" name="apply">
                                  <div class="form-group">
                                    <select class="custom-select" id="inputGroupSelect02" name="room_type" required>
                                    <option selected>Choose Room Type</option>
                                    <option value="THREE IN A ROOM">Three In A Room</option>
                                    <option value="EIGHT IN A ROOM">Eight In A Room</option>
                                    </select>
                                  </div>
                              <div class="form-group">
