        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="d-xl-flex justify-content-between align-items-start">
              <h2 class="text-dark font-weight-bold mb-2"> List of Suppliers </h2>
              <div class="d-sm-flex justify-content-xl-between align-items-center mb-2">
                <div class="dropdown ml-0 ml-md-4 mt-2 mt-lg-0">
                  <button class="btn btn-outline-primary" type="button" id="dropdownMenuButton1" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#exampleModal"> Add a Supplier</button>
                </div>
              </div>
            </div>
            <div class="row">
...
<!--Table goes here -->
                      ...
                      $serial_number=1;
                                    while($row= mysqli_fetch_array($result))
                                   {
                                        ...
                                        echo "<td><button type='submit' class='btn btn-danger' name='archive_supplier'>Archive</button></td>";
                                        echo "</form></tr>"; 
...
if (isset($_POST['archive_supplier'])) {
    $archiveSupplierId = $_POST['id'];

    // Use a transaction to ensure atomicity
    mysqli_autocommit($conn, false);

    // Move the record from the "suppliers" table to the "suppliers_archive" table
    $moveToArchiveQuery = "INSERT INTO asset_register.suppliers_archive SELECT * FROM asset_register.suppliers WHERE sup_id = '$archiveSupplierId'";
    $deleteFromSuppliersQuery = "DELETE FROM suppliers WHERE sup_id = '$archiveSupplierId'";

    $moveToArchiveResult = mysqli_query($conn, $moveToArchiveQuery);
    $deleteFromSuppliersResult = mysqli_query($conn, $deleteFromSuppliersQuery);

    if ($moveToArchiveResult && $deleteFromSuppliersResult) {
        // Commit the transaction
        mysqli_commit($conn);
        echo '<script>alert("Supplier successfully archived!"); window.location.href = "../supplier/";</script>';
    } else {
        // Rollback the transaction on failure
        mysqli_rollback($conn);
        echo '<script>alert("Error archiving supplier!"); window.location.href = "../supplier/";</script>';
    }
                            ...
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                  <label for="location">Enter Location of Supplier:</label>
                                  ...
                                  <div class="form-group">
                                  <label for="number">Enter Number of Supplier:</label>
