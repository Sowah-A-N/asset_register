...
<body>
    <form action="" method="post" class="flex items-center space-x-4">
        <label for="asset_class_select" class="text-lg font-semibold">Select Asset Sub-Class:</label>
            <?php 
...
/**
        echo "<tr><td class='border px-4 py-2'>". "Balance Brought Forward" ."</td>
        <td class='border px-4 py-2'>". (isset($a_class) ? $a_class :"") ."</td>
        ...
        <td class='border px-4 py-2'>".""."</td>
        <td class='border px-4 py-2'>".""."</td>
        <td class='py-2 px-4 border-b'>" . (isset($a_opening_bal) ? number_format(($a_asset_cost_op_bal), 2, ".", ","): "") . "</td>
        <td class='py-2 px-4 border-b'>" . (isset($a_opening_bal) ? number_format(($a_asset_cost_op_bal), 2, ".", ","): "") . "</td>
        <td class='py-2 px-4 border-b'>" . (isset($a_accum_depr_op_bal) ? number_format(($a_accum_depr_op_bal), 2, ".", ","): "") . "</td>
        <td class='py-2 px-4 border-b'>" ."". "</td>
        <td class='py-2 px-4 border-b'>" . (isset($a_total_accum_depr) ? number_format(($a_total_accum_depr), 2, ".", ","): "") . "</td>
        <td class='py-2 px-4 border-b'>" . (isset($a_opening_bal) ? number_format($a_depr_cost_per_charge, 2, ".", ","): "") . "</td>
        <td class='py-2 px-4 border-b'>" .(isset($a_closing_carry_value) ? number_format($a_closing_carry_value, 2, ".", ","): ""). "</td>
        <td class='py-2 px-4 border-b'>" . (isset ($a_lifetime) ? $a_lifetime : ""). "</td>
        <td class='py-2 px-4 border-b'>" . (isset ($a_lifetime) ? $a_lifetime : "") . "</td>";
